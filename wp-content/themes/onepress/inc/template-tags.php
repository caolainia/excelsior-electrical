...
if ( ! function_exists( 'onepress_footer_site_info' ) ) {
	...
	function onepress_footer_site_info() {
		?>
		<?php printf( 'Got questions? Do not hesitate to call us at: 0411 626 560' ); ?>
		<br>
		<?php printf( esc_html__('Email us at: %1$s', 'onepress'), 'yan20021109@gmail.com' ); ?>
		<!-- <span class="sep"> &ndash; </span> -->
		<?php // printf( esc_html__( '%1$s theme by %2$s', 'onepress' ), 'FameThemes' ); ?>
		<?php
	}
}
